...
du <- DUreport( counts, targets, offset = FALSE, ignoreExternal =TRUE, ignoreIo = TRUE)#version corta default
...
<<DU, eval=TRUE>>=
du_HNRNPC <- DUreport( counts, targets, offset = FALSE, ignoreExternal =TRUE, ignoreIo = TRUE)
@
